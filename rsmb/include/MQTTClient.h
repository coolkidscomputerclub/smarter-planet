/********************************************************************/
	...
	restricted by GSA ASP Schedule Contract with IBM Corp.

/********************************************************************/

/**
 * @mainpage MQTT Client library for C
 * &copy; Copyright IBM Corp. 2009, 2010
 * 
 * @brief An MQTT client library in C for Windows and Linux.
 *
...
typedef struct
{
	/** The LWT topic to which the LWT message will be publshed. */
	char* topicName;
	/** The LWT payload. */
	char* message;
	/**
...
/**
  ...
  * this memory using the free() library function.
